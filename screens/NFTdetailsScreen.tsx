...
const NFTdetailsScreen = ({ navigation, route }: Props) => {
    ...
    function getAttributes() {
        const result = subWalletNftsArray[nftIndex].Properties.attributes.map((item) => {
            return (
                <View>
                    <View 
                        style={{
                    ...
                    >
                        <Text 
                            style={{...theme.fonts.Nunito_Sans.Caption_S_SemiBold, color: theme.colors.primary, flex: 1,}}
                        >
        ...
        return (
            <View>
                ...
                <View style={{marginTop: 16, alignSelf: 'flex-start'}}>
                    <Text 
                        style={{...theme.fonts.Nunito_Sans.Body_M_Bold, color: theme.colors.black_four, marginBottom: 0, padding: 0,
                        }}
                        onPress={handlePress}
                    >
                        Read more
            ...
            return(            
                <TouchableOpacity 
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', marginVertical: 16}}>
                        <Text
                            style={{...theme.fonts.Nunito_Sans.Body_M_SemiBold, color: theme.colors.primary, }}
                        >
                            {shortenPublicKey(
                                item.address,
                                0,
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
				...
				>
                    <View style={{borderRadius: 8, height: 297}}>
                        ...
                        >
                            <Image 
                                ...
                                borderRadius: 8, marginBottom: 24, overlayColor: 'white'}}
                            />
                        </TouchableOpacity>
                    </View>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                        <View>
                            <Text 
                                style={{...theme.fonts.Azeret_Mono.Body_M_SemiBold, marginBottom: 0}}
                                numberOfLines={1}
                            >
                    ...
                    <View style={{}}>
                        ...
                        >
                            <Text 
                                    style={{
                                    ...theme.fonts.Nunito_Sans.Body_M_Regular, color: theme.colors.grey_eight,  includeFontPadding: false,
                                }} 
                            >
                                {formatDescription()}
                            </Text>
                        </ReadMore>
                        {subWalletNftsArray[nftIndex].Properties.attributes.length && shortDescription ? (
                            <View 
                ...
                <View 
                    ...
                    <Text style={{...theme.fonts.Azeret_Mono.Body_M_SemiBold}}>
                        Chain Info
                    </Text>
                    <View 
                        style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 16, paddingVertical: 21,
                        }}
                    >
                        <Text 
                            style={{...theme.fonts.Nunito_Sans.Caption_M_SemiBold, color: theme.colors.black_five,
                            }}  
                        >
                            Mint
                        </Text>
                        <TouchableOpacity
                            onPress={() => {
                                copyToClipboard(subWalletNftsArray[nftIndex].Mint);
                                onToggleSnackBar();
                            }}
                        >
                    ...
                    <View
                        style={{borderTopWidth: 1, borderTopColor: theme.colors.grey_four, marginBottom: 2, marginTop: 4}}
                    >
                    </View>
                    <View 
                    ...
                    >    
                        {subWalletNftsArray[nftIndex].Creators.length > 1 ? (
                            <Text  
                                style={{...theme.fonts.Nunito_Sans.Caption_M_SemiBold, color: theme.colors.black_five, alignItems: 'flex-start', marginTop: 23,
                                }}
                            >
                                Creators
                            </Text>
