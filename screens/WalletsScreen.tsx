...
import { Text, TouchableOpacity, StyleSheet, DevSettings, View, Image } from 'react-native';
					...
					{subWallets.map((subWallet, index) => {
						return (
							<TouchableOpacity
								...
								style={styles.pressableContainer}
								onPress={() => {
									navigation.navigate('Wallet Details', { shortKey: shortenPublicKey(subWallet.publicKey) } )
									console.log('hit');
				...
				<BottomSheetModal
					...
					>
						...
						>
							...
							>
								Please ensure that you have access to your secret phrase before logging out.
								</Text>
							<Text
								style={{
									...theme.fonts.Nunito_Sans.Body_M_SemiBold,
								...
								>
								Radiant does not store it and has no ability to access it for you.
							</Text>
