...
import { Text, TouchableOpacity, StyleSheet, DevSettings, Alert } from 'react-native';
...
const WalletDetailsScreen = ({ navigation, route }: Props) => {
    ...
    const copyToClipboard =  async () => {
        ...
        Alert.alert('Address Copied!', copiedKey, [{text: 'Okay', style: 'destructive' }])
    }
    ...
    return (
        <Background>
            <View>
                ...
                <TouchableOpacity style={styles.pressableContainer} onPress={() => { navigation.navigate('Edit Wallet Name') }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View>
                            ...
                            <View
                                style={styles.cardSubTitleContainer}>
                                <Text style={styles.cardSubTitle}>Wallet 1</Text>
                            </View>
                        </View>
                    </View>
                    <Image
                ...
                {subWallets.map((subWallet, index) => {
                    return (
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                copyToClipboard();
                                setCopiedKey(subWallet.publicKey);
            ...
            <View>
                <View style={styles.removeWalletButton}>
                    <RedButton mode="outlined" onPress={() => bottomSheetModalRef.current?.present()}>Remove Wallet</RedButton>
                </View>
            ...
            >
                ...
                >
                    ...
                    >
                        You can always re-import this wallet to Radiant in the future.
                            </Text>
                    <View style={styles.removeWalletButton}>
                        <RedButton
                            mode="contained"
